...
void FATIMA_TAMEX_Calibrator::load_Calibration_Files(){
	...
	ifstream map_file("Configuration_Files/FATIMA/Calibration_FATIMA_TAMEX/MAP.dat");
 ...
 //cout<<"tamex_id " <<tamex_id << endl;
	...
	for(int i = 0;i < iter;++i){
		...
		sprintf(filename,"Configuration_Files/FATIMA/Calibration_FATIMA_TAMEX/Calib_%d_%d.dat",tamex_id,ch_id);
		file.open(filename);
...
void FATIMA_TAMEX_Calibrator::ONLINE_CALIBRATION(){
	...
	ofstream map_file("Configuration_Files/FATIMA/Calibration_FATIMA_TAMEX/MAP.dat");
	...
	for(int i = 0;i < 100;++i){
		for(int j = 0;j < 100;++j){
			...
			if(fired[i][j]){
				...
				sprintf(filename,"Configuration_Files/FATIMA/Calibration_FATIMA_TAMEX/Calib_%d_%d.dat",i,j);
