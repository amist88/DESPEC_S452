...
cout << "CorrelParameter - reading from Configuration_Files/DESPEC_General_Setup/Correlations_config.dat";
       ...
       ///AIDA Implants bPlas WR Time Gate
       if(IsData(file)) file >> GAIDA_Imp_bPlas_TLow >>GAIDA_Imp_bPlas_THigh;
       
       ///AIDA Decays bPlas WR Time Gate
...
Int_t CorrelParameter::PrintParameter(Text_t *buf, Int_t)
{
  ...
  cout<<  "\tBeta-delayed Gammas:: " <<  GSetup_corr_Beta_Gamma  <<"  ,Ge Gamma-Gamma: " << GSetup_corr_Beta_Gamma_Gamma << " ,BDG with Fatima: " << GSetup_corr_Beta_Gamma_Fatima << " ,BDG Lifetimes " << GSetup_corr_FRS_Fatima_LT<<endl;
  ...
  cout<<" ==================================================================================="<<endl; 
  cout<<"\t\tFRS Galileo Time Gate Long isomer" <<endl;
  ...
  cout<<" ==================================================================================="<<endl; 
  cout << "\tFRS Fatima WR Time Gate" << GFRS_Fat_TLow << " -- " <<  GFRS_Fat_THigh <<  endl;
  ...
  cout <<"\n\tAida ('good') Decay Energy Max Front(keV): " << GAIDA_DecEFront << ", Aida ('good') Decay Energy Max Back(keV) " <<  GAIDA_DecEBack<<endl;
...
//       GbPlast_GAL_THigh = from->GbPlast_GAL_THigh; 
      ...
      GPID_Gate_FRS_Fatima_LT=from->GPID_Gate_FRS_Fatima_LT;
       ...
       GAIDA_Imp_bPlas_TLow = from->GAIDA_Imp_bPlas_THigh;
