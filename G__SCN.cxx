...
struct __attribute__((annotate("$clingAutoload$EventAnlStore.h")))  __attribute__((annotate("$clingAutoload$./EventAnlProc.h")))  AidaAnlData;
...
class __attribute__((annotate("$clingAutoload$EventAnlStore.h")))  __attribute__((annotate("$clingAutoload$./EventAnlProc.h")))  EventAnlStore;
