...
//   }
 ...
 /*
  ...
  frs->dispersion[1]    =  7.835;//focus set at 4 m at S4 //7.670 RUN81-TA2B-220CM 27.05.2016
  ...
  //144Dy, S468 2020-april-11
  frs->bfield[0] = 12.7471; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[1] = 12.7471; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[2] = 11.1099; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[3] = 11.1099; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
...
// TOF calibration SC21-SC81 (TAC)
  ...
  id->a4AoQCorr = 0.0;
  id->vel_a[0] =   15712.3; //  MUSIC41 velocity corr. S468
  id->vel_a[1] =  -24957;   // 
  id->vel_a[2] =   11630.2; // 
  id->vel_a[3] =   0.0;
  id->vel_a2[0] =  15275.4 ; // MUSIC42 velocity corr. S468
  id->vel_a2[1] = -23944.;
  id->vel_a2[2] =  10891.9;
  id->vel_a2[3] =  0.0;
  ...
  id->id_tofoff2 =  174492.;  // offset (ps) first fit S468 
  id->id_path2   =  123195.;  // path/c (ps)
  id->id_tofoff3  = 175652.;   // [ps] guess
  id->id_path3    = 124420.;   // path/c [ps]

  id->mhtdc_length_s2s4 = 37;
  id->mhtdc_vel_a_music41[0]=15712.3;
  id->mhtdc_vel_a_music41[1]=-24957; 
  id->mhtdc_vel_a_music41[2]=11630.2; 
  id->mhtdc_vel_a_music41[3]=0.0;
  id->mhtdc_vel_a_music42[0]=15275.4 ;
  id->mhtdc_vel_a_music42[1]=-23944.;
  id->mhtdc_vel_a_music42[2]=10891.9;
  ...
  tpc->timeref_calibrun[2] = 1060.; //sc21
  tpc->lim_csum1[2][0] = 500.;   tpc->lim_csum1[2][1]= 1000.0; //2020/apr/08
  ...
  tpc->x_offset[2][0] = 26.844962; //Pb208 2020APRIL
  tpc->x_offset[2][1] = 18.572490;
  tpc->x_factor[2][0] = 0.069355;
  tpc->x_factor[2][1] = 0.069602;
  tpc->y_offset[2][0] = 57.085058;
  tpc->y_offset[2][1] = 59.188520;
  tpc->y_offset[2][2] = 54.322700;
  tpc->y_offset[2][3] = 56.459470;
  tpc->y_factor[2][0] = -0.034213;
  tpc->y_factor[2][1] = -0.034292;
  tpc->y_factor[2][2] = -0.034067;
  tpc->y_factor[2][3] = -0.034184; 

  
  //TPC 4 at S2 (TPC 24) in air
  tpc->id_tpc_timeref[3] = 1; //sc21
  tpc->timeref_calibrun[3] = 1037.0; //sc21
  tpc->lim_csum1[3][0] = 200.;     tpc->lim_csum1[3][1]= 700.0; //2020/apr08/Pb
  ...
  tpc->x_offset[3][0] = 14.168973; // tpc24 2020/apr/09 Pb beam
  tpc->x_offset[3][1] = 19.380757;
  tpc->x_factor[3][0] = 0.076616;
  tpc->x_factor[3][1] = 0.074511;
  tpc->y_offset[3][0] = 74.195418;
  tpc->y_offset[3][1] = 75.418168;
  tpc->y_offset[3][2] = 56.054435;
  tpc->y_offset[3][3] = 75.095255;
  tpc->y_factor[3][0] = -0.033494;
  tpc->y_factor[3][1] = -0.033373;
  tpc->y_factor[3][2] = -0.024037;
  tpc->y_factor[3][3] = -0.033929; 
  
  //TPC 5  at S4 (TPC 41) in air //08/april/2020 run369
  tpc->id_tpc_timeref[4] = 0; //sc41
  tpc->timeref_calibrun[4] = 424.0; //sc41
  ...
  tpc->x_offset[4][0] = -1.724723; //Pb208, run369 2020april08
  tpc->x_offset[4][1] = 1.830604;
  tpc->x_factor[4][0] = 0.085513;
  tpc->x_factor[4][1] = 0.084902;
  tpc->y_offset[4][0] = 63.856867;
  tpc->y_offset[4][1] = 64.174988;
  tpc->y_offset[4][2] = 63.633440;
  tpc->y_offset[4][3] = 63.287465;
  tpc->y_factor[4][0] = -0.041843;
  tpc->y_factor[4][1] = -0.042526;
  tpc->y_factor[4][2] = -0.041806;
  tpc->y_factor[4][3] = -0.041737; 

  //-------- TPC42 parameters (S468 2020Apr run_0389 Pb208) --------//
  // TPC 6 at S4 (TPC 42) in air
  tpc->id_tpc_timeref[5] = 0; //sc41
  tpc->timeref_calibrun[5] = 435.9; //sc41
  tpc->x_offset[5][0] = -3.463482; // 
  tpc->x_offset[5][1] = -3.603847;
  tpc->x_factor[5][0] = 0.082854;
  tpc->x_factor[5][1] = 0.085546;
  tpc->y_offset[5][0] = 88.423689;
  tpc->y_offset[5][1] = 90.620550;
  tpc->y_offset[5][2] = 89.028847;
  tpc->y_offset[5][3] = 75.023419;
  tpc->y_factor[5][0] = -0.041130;
  tpc->y_factor[5][1] = -0.041410;
  tpc->y_factor[5][2] = -0.042472;
  tpc->y_factor[5][3] = -0.041458; 
  tpc->lim_csum1[5][0] = -600.0;    tpc->lim_csum1[5][1] = -10.0;
  tpc->lim_csum2[5][0] = -600.0;    tpc->lim_csum2[5][1] = -10.0;
  tpc->lim_csum3[5][0] = -600.0;    tpc->lim_csum3[5][1] = -10.0;
  tpc->lim_csum4[5][0] = 100.0;    tpc->lim_csum4[5][1] = 700.0;

  //TPC at S3 (TPC 31)
  tpc->id_tpc_timeref[6] = 2; //sc31
  tpc->timeref_calibrun[6] = 366.7; //sc31
  tpc->x_offset[6][0] = 12.304933;//2020April S468
  tpc->x_offset[6][1] = 5.924194;
  tpc->x_factor[6][0] = 0.083360;
  tpc->x_factor[6][1] = 0.081906;
  tpc->y_offset[6][0] = -100.227568;
  tpc->y_offset[6][1] = -95.734259;
  tpc->y_offset[6][2] = -91.035374;
  tpc->y_offset[6][3] = -92.629390;
  tpc->y_factor[6][0] = 0.047502;
  tpc->y_factor[6][1] = 0.047855;
  tpc->y_factor[6][2] = 0.047335;
  tpc->y_factor[6][3] = 0.046994;
  tpc->lim_csum1[6][0] = -1000.0;    tpc->lim_csum1[6][1] = -10.0;
  tpc->lim_csum2[6][0] = -1000.0;    tpc->lim_csum2[6][1] = -10.0;
  tpc->lim_csum3[6][0] = -1000.0;    tpc->lim_csum3[6][1] = -10.0;
  tpc->lim_csum4[6][0] = -1000.0;    tpc->lim_csum4[6][1] = -10.0;
  ...
  */
  //2020/April/08 S468
  sci->tac_factor[0]  = 10.5675; //SC21L-R [ps/ch]     >> ch0 of ADC
  sci->tac_factor[1]  = 10.6968; //SC41L-R [ps/ch]     >> ch1 of ADC
  sci->tac_factor[2]  = 11.1536; //SC41L-SC21L [ps/ch] >> ch5 of ADC
  sci->tac_factor[3]  = 10.9765; //SC41R-SC21R [ps/ch] >> ch6 of ADC
  sci->tac_factor[4]  = 10.5438; //SC42L-R             >> ch2 of ADC
  sci->tac_factor[5]  = 10.8122; //SC42L-SC21L [ps/ch] >> ch8 of ADC
  sci->tac_factor[6]  = 10.6187; //SC42R-SC21R [ps/ch] >> ch7 of ADC
  sci->tac_factor[7]  = 11.0168; //SC43L-R [ps/ch]     >> ch3 of ADC
  sci->tac_factor[8]  = 10.0000; //SC81L-R [ps/ch]     >> ch4 of ADC
  sci->tac_factor[9]  = 20.0000; //SC81L-SC21L         >> ch9
  sci->tac_factor[10] = 20.0000; //SC81R-SC21R         >> ch10
  sci->tac_factor[11] = 10.5360; //SC22L-R             >> ch11
  sci->tac_factor[12] = 10.0922; //SC41L-SC22L [ps/ch] >> ch12
  sci->tac_factor[13] = 10.8017; //SC41R-SC22R [ps/ch] >> ch13
  ...
  //rangescan 43
  id->ID_Z_AoverQ[0][0][0]=2.200      ; id->ID_Z_AoverQ[0][0][1]=64.6;
  id->ID_Z_AoverQ[0][1][0]=2.200      ; id->ID_Z_AoverQ[0][1][1]=65.5;
  id->ID_Z_AoverQ[0][2][0]=2.218      ; id->ID_Z_AoverQ[0][2][1]=65.5;
  id->ID_Z_AoverQ[0][3][0]=2.218      ; id->ID_Z_AoverQ[0][3][1]=64.6;
  id->ID_Z_AoverQ[0][4][0]=2.200      ; id->ID_Z_AoverQ[0][4][1]=64.6;
