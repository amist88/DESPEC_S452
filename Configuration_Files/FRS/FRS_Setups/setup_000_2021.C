...
//   }
 /*
  ...
  frs->bfield[0] = 12.6853; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[1] = 12.6853; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[2] = 11.0201; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[3] = 11.0201; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
