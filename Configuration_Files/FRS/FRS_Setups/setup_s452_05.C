...
//   }
 ...
 /*
  ...
  //208Pb for s483 
  frs->bfield[0] = 12.9031;//                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[1] = 11.9536;//                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[2] = 9.6195; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[3] = 9.6195; //                 Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
