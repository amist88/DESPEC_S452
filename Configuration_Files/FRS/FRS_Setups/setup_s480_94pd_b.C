...
void setup_s480_94pd_b()
{
 ...
 /*
  ...
  frs->dist_S4target= 4400.0; //for some experiments
  ...
  frs->bfield[0] = 8.3771; // FRS D1 for Cd98 // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[1] = 8.3771; // D2 for Cd98 // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[2] = 6.4212 ; // D3 for Cd98 // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
  frs->bfield[3] = 6.4212 ; // D4 for Cd98 // Please do NOT comment-out old brho and add new brho. Please make a NEW setup file. 
...
// TOF calibration SC21-SC81 (TAC)
  ...
  */
  ...
  id->ID_Z_AoverQ[0][0][0]=2.045      ; id->ID_Z_AoverQ[0][0][1]=50.2;
  id->ID_Z_AoverQ[0][1][0]=2.045      ; id->ID_Z_AoverQ[0][1][1]=49.2;
  id->ID_Z_AoverQ[0][2][0]=2.075      ; id->ID_Z_AoverQ[0][2][1]=49.2;
  id->ID_Z_AoverQ[0][3][0]=2.075      ; id->ID_Z_AoverQ[0][3][1]=50.2 ;
  id->ID_Z_AoverQ[0][4][0]=2.045      ; id->ID_Z_AoverQ[0][4][1]=50.2;
