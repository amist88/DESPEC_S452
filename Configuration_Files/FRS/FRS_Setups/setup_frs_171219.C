...
void setup_er2019_FRS000_018()
{
  ...
  an->SetupH2("ID_Z_AoQ", 600, 1.3, 2.8,600 , 35, 95, "A/Q", "Z"); 
  ...
  */
  ...
  // U  beam
  //id-> id_tofoff2 =  176920.01;    // Offset (ps)
...
// =======
 ...
 id->ID_x2AoverQ[0][4][0]=2.24433;id->ID_x2AoverQ[0][4][1]=42.5864;
  ...
  // 238U primary beam, run0895
   //frs->bfield[0] = 13.037;// Brho 2019-Dec12
   //frs->bfield[1] = 13.037;
   //frs->bfield[2] = 12.9293; // Brho 2019-Dec12
   //frs->bfield[3] = 12.9293;
  //frs->bfield[2] = 12.7731; // test run896
  //frs->bfield[3] = 12.7731; //test run896
	
	 // 238U primary beam,  165W fragments
//   frs->bfield[0] = 10.1204; // 2019-Dec12 
//   frs->bfield[1] = 10.1204;
//   frs->bfield[2] = 8.3074; // Brho 2019-Dec12
//   frs->bfield[3] = 8.3074;

	 // 238U primary beam,  cu target
		  //   frs->bfield[0] = 13.0369; // 2019-Dec12 
		  //   frs->bfield[1] = 13.0369;
//   frs->bfield[2] = 12.7723; // Brho 2019-Dec12
//   frs->bfield[3] = 12.7723;

   //238U primaty beam prod targe
  // frs->bfield[0] = 11.7551; // 2019-Dec12 
  // frs->bfield[1] = 11.7551;
  // frs->bfield[2] = 8.8216; // Brho 2019-Dec12
  // frs->bfield[3] = 8.8216;

   //168Re fragment
   frs->bfield[0] = 10.1715; // 2019-Dec12 
   frs->bfield[1] = 10.1715;
   frs->bfield[2] = 7.8216; // Brho 2019-Dec12
   frs->bfield[3] = 7.8216;
   //primary u, file 924
 //  frs->bfield[0] = 10.1715; // 2019-Dec12 
 //  frs->bfield[1] = 10.1715;
 //  frs->bfield[2] = 9.4669; // Brho 2019-Dec12
 //  frs->bfield[3] = 9.4669;
  ...
  // // id->vel_a[1] =   -7090.0;
  // // id->vel_a[2] =   0.0;
  // // id->vel_a[3] =   0.0;  // 2019 nov20 40Ar, setting 18.
  // frs->primary_z = 18.;
  // frs->offset_z  =  0.;
  // frs->a2AoQCorr = 0.00095;
  // frs->a4AoQCorr = 0.0000;//0.0015
  ...
  // // MUSIC 1 velocity correction  YT 
  // 2019/Dec/12 with U238 primary beam
  id->vel_a[0] = 8232.58;
  id->vel_a[1] = -6483.04;
  id->vel_a[2] =   0.0;
  id->vel_a[3] =   0.0;  // 2019Dec12 238U,
  // frs->primary_z = 18.;
  // frs->offset_z  =  0.;
  // frs->a2AoQCorr = 0.00095;
  // frs->a4AoQCorr = 0.0000;//0.0015
