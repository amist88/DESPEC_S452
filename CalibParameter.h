...
public:
 ...
 Double_t Afat_TAMEX[FATIMA_TAMEX_CHANNELS], Bfat_TAMEX[FATIMA_TAMEX_CHANNELS], Cfat_TAMEX[FATIMA_TAMEX_CHANNELS], Dfat_TAMEX[FATIMA_TAMEX_CHANNELS], Extra1fat_TAMEX[FATIMA_TAMEX_CHANNELS];
