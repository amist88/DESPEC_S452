...
void FATIMA_Detector_System::Process_MBS(int* pdata){
    ...
    //check for QDC and TDC and Scaler header
   ...
   Scaler_Module = SCALER_MODULE_ON;
...
//    
//          data = *pdata++;
//         // printf("ALLdata= 0x%08x\n",data);
//          if ((data & 0xFF000000) == 0x7a000000){
//              scaler_header=true;
//          Int_t vme_geo = getbits(*pdata,2,12,5);
//          vme_type = getbits(*pdata,2,9,3);
//          vme_nlw =  getbits(*pdata,2,3,6);
//      // cout<<"vme_geo " << vme_geo <<" vme_type " <<vme_type << " vme_nlw " <<vme_nlw<< endl;
//           //printf("1data= 0x%08x\n",data);
//          }
//        //cout<<"vme_type " <<vme_type << endl;
//          if(scaler_header==true )   
//          {
//             
//              data = *pdata++;
//              ///Trailer reached
//               if ((data & 0xFFFF0000) == 0x7c000000 || vme_type!=0){
//             break;  // exit loop   
//             scaler_header=false;
//             Scaler_iterator=0;
//         }
...
//         //  printf("2data= 0x%08x\n",data);
//        
//           Scaler_Data[Scaler_iterator] = data;
//            //cout<<"Scaler_Data[Scaler_iterator] " <<Scaler_Data[Scaler_iterator]<< " Scaler_iterator " << Scaler_iterator << endl;
// //          cout<<"Scaler_iterator " <<Scaler_iterator<< endl;
//          Scaler_iterator++; 
//             
//        }  
//        
