...
void PLASTIC_TAMEX_Detector_System::Process_TAMEX(){
 ...
 //if(tamex_id[tamex_iter]==0)   cout<<"tamex_id[tamex_iter] "<<tamex_id[tamex_iter]<<endl;
      //next word
    pdata++;
...
//         }
   ...
   // cout <<"ch_ID_edge[tamex_iter][iterator[tamex_iter]] " <<ch_ID_edge[tamex_iter][iterator[tamex_iter]] << " tamex_iter "<<tamex_iter << " iterator[tamex_iter] " <<iterator[tamex_iter] << endl;
  
//        if(tamex_iter==0&&(ch_ID_edge[tamex_iter][iterator[tamex_iter]]==0||ch_ID_edge[tamex_iter][iterator[tamex_iter]]==1)){
//      cout<<"!!!!!!!!ch_ID_edge[tamex_iter][iterator[tamex_iter]] " <<ch_ID_edge[tamex_iter][iterator[tamex_iter]] << " tamex_iter " <<tamex_iter << " iterator[tamex_iter] " <<iterator[tamex_iter]<< endl;
//    }
//        if(tamex_iter==1){
//     cout<<"!!!!!!!!ch_ID_edge[tamex_iter][iterator[tamex_iter]] " <<ch_ID_edge[tamex_iter][iterator[tamex_iter]] << " tamex_iter " <<tamex_iter << " iterator[tamex_iter] " <<iterator[tamex_iter]<<"  edge_fine " << edge_fine[tamex_iter][iterator[tamex_iter]] <<  " coarse_T " <<edge_coarse[tamex_iter][iterator[tamex_iter]] << endl;
//            
//     
//     }
...
//     if(tamex_iter==1){
//        cout<<"ch_num[tamex_iter][iterator[tamex_iter]] " <<ch_num[tamex_iter][iterator[tamex_iter]] << " tamex_iter " << tamex_iter << " iterator[tamex_iter] " <<iterator[tamex_iter] << endl;
//     }
