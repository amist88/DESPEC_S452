...
void FINGER_Calibrator::load_Calibration_Files(){
    ...
    ifstream map_file("Configuration_Files/FINGER/Calibration_FINGER/MAP.dat");
    ...
    for(int i = 0;i < iter;++i){
        ...
        sprintf(filename,"Configuration_Files/FINGER/Calibration_FINGER/Calib_%d_%d.dat",tamex_id,ch_id);
        file.open(filename);
...
void FINGER_Calibrator::ONLINE_CALIBRATION(){
    ...
    ofstream map_file("Configuration_Files/FINGER/Calibration_FINGER/MAP.dat");
    ...
    for(int i = 0;i < 100;++i){
        for(int j = 0;j < 100;++j){
            ...
            if(fired[i][j]){
                ...
                sprintf(filename,"Configuration_Files/FINGER/Calibration_FINGER/Calib_%d_%d.dat",i,j);
